<%--<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="GarudaWEB.Login"  MasterPageFile="~/Garuda.Master"%>

<asp:Content ID="login_content" ContentPlaceHolderID="GarudaContent" runat="server">
    <div>
        <table style="width: 407px; height: 221px">
            <tr>
                ...
                <td style="width: 100px">
                    <asp:RequiredFieldValidator ID="Usernamevld" runat="server" ErrorMessage="Username Harus Di isi" ControlToValidate="Username"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                <td style="width: 100px">
                ...
                <td style="width: 100px">
                 <asp:RequiredFieldValidator ID="Passwordvld" runat="server" ErrorMessage="Password Harus Di isi" ControlToValidate="Password"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                <td style="width: 100px">
                ...
                <td style="width: 100px">
                    <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/Register.aspx" Width="212px">Belum punya akun? Daftar disini</asp:HyperLink>
                </td>
            </tr>
        </table>
    </div>
